      ...
      {timings ? (
        <div>
          ...
          <div className="header">
            <div className="sunrise_container">
              <div className="image_text_container">
                <img src={sunrise} alt="Sunrise" className="sunrise_icon" />
            ...
            <div className="sunrise_container">
              <div className="image_text_container">
                <img src={sunset} alt="Sunset" className="sunrise_icon" />
          ...
          {closestPrayer?.minutes == null ? (
            ...
            <h2 className="next_prayer_minutes">
              Next Iqama For:{" "}
              <span className="next_prayer_span">
                {closestPrayer?.name +
                  ` (${toArabic(closestPrayer?.name || "")})`}
              </span>{" "}
              in{" "}
